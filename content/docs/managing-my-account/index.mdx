...
<div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
  <Card title="Subscription Management" href="/docs/managing-my-account/subscription" icon="package" />
  <Card title="Payments & Billing" href="/docs/managing-my-account/billing" icon="credit-card" />
  <Card title="User & Account Settings" href="/docs/managing-my-account/user-settings" icon="settings" />
</div>
