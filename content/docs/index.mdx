...
<Cards>
  <Card title="Solution Guides" href="/docs/bookkeeping-tax-solution-guides" icon="lucide-book-open" />
  <Card title="Getting Started" href="/docs/getting-started" icon="lucide-play-circle" />
  <Card title="Using the Uplinq App" href="/docs/using-the-uplinq-app" icon="lucide-layout" />
  <Card title="Integrations & Troubleshooting" href="/docs/integrations-troubleshooting" icon="lucide-link" />
  <Card title="Managing My Account" href="/docs/managing-my-account" icon="lucide-user" />
  <Card title="Security & Privacy" href="/docs/security-privacy" icon="lucide-shield" />
</Cards>
