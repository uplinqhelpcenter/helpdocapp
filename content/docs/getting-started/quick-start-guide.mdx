...
<Cards>
  <Card href="/help/get-started/connecting-financial-accounts" title="Connecting Accounts Guide" icon="link">
    Details on linking bank accounts via Plaid.
  </Card>
  <Card href="/help/data-hub/uploading-documents" title="Uploading Documents" icon="upload-cloud">
    How to use the Data Hub to fulfill requests.
  </Card>
  <Card href="/help/contact-support" title="Contact Support" icon="headphones">
