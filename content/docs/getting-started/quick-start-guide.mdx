...
<Cards>
  <Card href="/help/get-started/connecting-financial-accounts" title="Connecting Accounts Guide">
    Details on linking bank accounts via Plaid.
  </Card>
  <Card href="/help/data-hub/uploading-documents" title="Uploading Documents">
