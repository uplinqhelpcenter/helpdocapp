...
**Q: Can you customize our invoice template with our branding?**  
 A: Basic branding (logo, colors) is included. For custom designs with special fields or layouts, we can refer you to our design partners.

**Q: Do you integrate with any CRM systems?**  
 A: Yes, we support integrations with popular CRMs like Salesforce, HubSpot, and Zoho CRM. Custom integrations may require additional setup fees.

**Q: How do you handle recurring invoices?**  
 A: We can set up automatic recurring invoices for subscription services, retainers, or other regular billing cycles.

**Q: What payment methods can customers use?**  
 A: We support credit cards, ACH/bank transfers, and digital wallets through integrated payment processors. Check and cash handling requires A/R Premium.

**Q: Can I see real-time payment status?**  
 A: Yes, our client dashboard provides real-time visibility into payment status, with automatic notifications when payments are received.
